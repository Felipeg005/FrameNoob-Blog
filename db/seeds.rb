...
user1 = User.create(id: 1, name: "Rudolph", photo: "link#", bio: "I love dancing", posts_counter: 1)
user2 = User.create(id: 2, name: "Mike", photo: "link#", bio: "I love hiking", posts_counter: 3)
