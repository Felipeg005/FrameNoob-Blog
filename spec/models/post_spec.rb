...
RSpec.describe Post, type: :model do
  subject { Post.new(id: 1, author_id: 1, title: 'I like rails', text: 'Great framework', comments_counter: 0, likes_counter: 0) }
  ...
  describe 'Test post model methods' do
    ...
    it 'Should increment comment_counter after adds a new comment' do
      post = Post.create(id: 1, author_id: 1, title: 'I like rails', text: 'Great framework', comments_counter: 0, likes_counter: 0)
